...
- (void)addDefaultBookmarks {
    [self addBookmark:@"http://hassadee.com/"
            withTitle:@"Hassadee's Blog"];
	...
	[self addBookmark:@"http://bluemooncode.dyndns.org/~hapztron/x3domx/3dch/index.html"
			withTitle:@"3D Color RGB"];
	[self addBookmark:@"http://bluemooncode.dyndns.org/~hapztron/geoztron/proj/olppark/index.html"
			withTitle:@"Geoztron: Olympia Park"];
	[self addBookmark:@"http://bluemooncode.dyndns.org/~hapztron/geoztron/proj/samed/samed.html"
			withTitle:@"Geoztron: Koh Samed"];
}
